...
namespace MVCReviewSite.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewID,Title,Content,Name,PublishedDate,Location,CategoryID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewID,Title,Content,Name,PublishedDate,Location,CategoryID")] Review review)
        {
            if (ModelState.IsValid)
            {
